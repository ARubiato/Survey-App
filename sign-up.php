                           ...
                           <form action="sign-up.php" method = "post">
                            ...
                            <div class = "form-group">
                                ...
                                <div class="form-group col-md-3 col-md-offset--2">
                                  ...
                                  <input list="bday" name="bday" class ="form-control" placeholder="Day"/></label>
                                  <datalist id="bday">
                                 <option> - Day - </option>
                                    ...
                                    <div class="form-group col-md-3 col-md-offset--2">
                                  <div class = "form-group col-md-10"></div>
                                  <input list="bmonth" name="bmonth" class ="form-control" placeholder="Month"/></label>
                                  <datalist id="bmonth">
                                 ...
                                 <div class="form-group col-md-3 col-md-offset--2">
                                  <div class = "form-group col-md-10"></div>
                                  <input list="byear" name="byear" class ="form-control" placeholder="Year"/></label>
                                  <datalist id="byear">
